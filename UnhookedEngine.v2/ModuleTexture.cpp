...
GLuint ModuleTexture::GenParticleTexture(GLuint* imgData, GLuint width, GLuint height)
{
...
GLuint ModuleTexture::LoadParticleTexture(string path)
{
	...
	if (success == IL_TRUE)
	{
		...
		if (success == IL_TRUE)
		{
			...
			TextID = GenParticleTexture((GLuint*)ilGetData(), (GLuint)ilGetInteger(IL_IMAGE_WIDTH), (GLuint)ilGetInteger(IL_IMAGE_HEIGHT));
		}
